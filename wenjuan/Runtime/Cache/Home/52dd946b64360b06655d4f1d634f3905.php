                ...
                <fieldset class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8 col-xs-7">
                                <input type="text" class="form-control" name="credentials_type" value="" nullmsg="" datatype="s" >
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                   ...
                   <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8 col-xs-7">
                                <input type="text" class="form-control" name="jjlx_email" required data-rule-mail="true" data-msg-required="请输入正确的邮箱">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
