            ...
            <input type="hidden" name="goto" value="/questionnaire/qita/care_id/<?php echo ($care_id); ?>/oname/qsxwnl" />
                <fieldset class="row" style="margin:0 15px">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-9 ">这是一张图（见下表），请您在同一张纸上照样画出来<br>
                            （对：两个五边形的图案，交叉处有一个四边形）（最高分:1分）<br>
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[10][defen]" value="" required>分
                            <img src="<?php echo C('RES_DOMAIN');?>/Public/images/rznlpg.png" alt="">
                        </label>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-md-12 ">总得分：<input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px"  value="" required>分
                        </label>
                        <h5>评分标准：
