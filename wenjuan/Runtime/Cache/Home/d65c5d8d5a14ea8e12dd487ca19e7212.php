            ...
            <input type="hidden" name="goto" value="/questionnaire/qita/care_id/<?php echo ($care_id); ?>/oname/qsxwnl" />
                <fieldset class="row">
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-12 control-label">现在是星期几？几号？几月？什么季节？哪一年？(最高分:5分）
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[0][defen]" value="" required>分
                        </label>
                        <label class="col-md-12 control-label">我们现在在哪里：省？市？医院？科室？第几层楼？(最高分:5分）
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[1][defen]" value="" required>分
                        </label>
                    </div>
                    <div class="form-group col-md-12">
                        <h4><strong>记忆力</strong></h4>
                        <label class="col-md-9 control-label">现在我要说三样东西的名称，在我讲完后，请您重复一遍。请您记住这三样东西，因为几分钟后要再问您的。（请仔细说清楚，每一样东西一秒钟）。
                            ...
                            “皮球”、“国旗”、“树木”。请您把三样东西说一遍（以第一次答案记分）(最高分:3分）" />
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[2][defen]" value="" required>分
                        </label>
                    </div>
                    <div class="form-group col-md-12">
                        <h4><strong>注意力和计算力</strong></h4>
                        <label class="col-md-9 control-label">请您算一算100减去7，然后从所得数目再减去7，如此一直计算下去，请您将每减一个7后答案告诉我，直到我说“停止”为止。（若错了，但下一个答案是对的，那么只记一次错误）。 (最高分:5分）<br>
                            例：  93      86      79     72      65
                            <input type="hidden" name="pg_qa[3][question]" value="注意力和计算力: 请您算一算100减去7，然后从所得数目再减去7，如此一直计算下去，请您将每减一个7后答案告诉我，直到我说“停止”为止。（若错了，但下一个答案是对的，那么只记一次错误）。 (最高分:5分）<br>
                            例：  93      86      79     72      65"/>
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[3][defen]" value="" required>分
                        </label>
                    </div>
                    <div class="form-group col-md-12">
                        <h4><strong>回忆能力</strong></h4>
                        <label class="col-md-9 control-label">现在请您说出刚才我让您记住的那三样东西？(最高分:3分）<br>
                            “皮球”“国旗”“树木”
                            <input type="hidden" name="pg_qa[4][question]" value='回忆能力: 现在请您说出刚才我让您记住的那三样东西？(最高分:3分）<br>
                            “皮球”“国旗”“树木”'/>
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[4][defen]" value="" required>分
                        </label>
                    </div>
                    <div class="form-group col-md-12">
                        <h4><strong>语言能力</strong></h4>
                        <input type="hidden" name="pg_qa[5][question]" value="语言能力:（出示手表）这个东西叫什么？(最高分:1分）">
                        <label class="col-md-9 control-label">（出示手表）这个东西叫什么？(最高分:1分）
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[5][defen]" value="" required>分
                        </label>
                        <input type="hidden" name="pg_qa[6][question]" value="（出示钢笔）这个东西叫什么？(最高分:1分）">
                        <label class="col-md-9 control-label">（出示钢笔）这个东西叫什么？(最高分:1分）
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[6][defen]" value="" required>分
                        </label>
                        <input type="hidden" name="pg_qa[7][question]" value="现在我要说一句话，请您跟着我清楚的重复一遍。“四十四只石狮子”(最高分:1分）">
                        <label class="col-md-9 control-label">现在我要说一句话，请您跟着我清楚的重复一遍。“四十四只石狮子”(最高分:1分）
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[7][defen]" value="" required>分
                        </label>
                        <input type="hidden" name="pg_qa[8][question]" value="我给您一张纸请您按我说的去做，现在开始：“用右手拿着这张纸，用两只手将它对折起来，放在您的大腿上”。（不要重复说明，也不要示范）(最高分:1分）">
                        <label class="col-md-9 control-label">我给您一张纸请您按我说的去做，现在开始：“用右手拿着这张纸，用两只手将它对折起来，放在您的大腿上”。（不要重复说明，也不要示范）(最高分:1分）<br>
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[8][defen]" value="" required>分
                        </label>
                        <input type="hidden" name="pg_qa[9][question]" value="您给我写一句完整的句子。（句子必须有主语、谓语、宾语）记下所叙述句子的全文。（最高分:1分）">
                        <label class="col-md-9 control-label">您给我写一句完整的句子。（句子必须有主语、谓语、宾语）记下所叙述句子的全文。（最高分:1分）<br>
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[9][defen]" value="" required>分
                        </label>
                        <input type="hidden" name="pg_qa[10][question]" value="这是一张图（见下表），请您在同一张纸上照样画出来<br>
                            （对：两个五边形的图案，交叉处有一个四边形）（最高分:1分）<br>">
                        <label class="col-md-9 control-label">这是一张图（见下表），请您在同一张纸上照样画出来<br>
                            （对：两个五边形的图案，交叉处有一个四边形）（最高分:1分）<br>
                            <input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[10][defen]" value="" required>分
                            <img src="#" alt="">
                        </label>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">总得分：<input type="text" class="form-control" style="display: inline;width: 20%;margin:0 15px"  value="" required>分
                        </label>
                        <p>评分标准：分数在27-30分：正常2、分数<27分：认知功能障碍3、分数<17分：认知功能重度障碍。
                        </p>
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-1 control-label" style="padding-right: 5px">不适用原因 ：</label>
                        <div class="col-md-11">
                            <label class="checkbox-inline">
