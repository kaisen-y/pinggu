                ...
                <fieldset class="row" style="margin:0 15px">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-12 ">现在是星期几？几号？几月？什么季节？哪一年？(最高分:5分）
                            <input type="number" class="form-control num" style="display: inline;width: 20%;margin:0 15px" name="pg_qa[0][defen]" value="" required>分
                        </label>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-9 ">这是一张图<button type="button" id="showimg">点击显示图片</button>，请您在同一张纸上照样画出来（最高分:1分）<br>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <h5>评分标准：<input type="hidden" value="30" name="pgcount">
