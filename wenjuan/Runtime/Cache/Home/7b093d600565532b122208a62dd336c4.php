            ...
            <input type="hidden" name="goto" value="/questionnaire/qita/care_id/<?php echo ($care_id); ?>/oname/rznlpg" />
                <fieldset class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">进食：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">转移：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">修饰：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">上厕所：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">洗澡：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">行走（平地45m）：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">上下楼梯：
                        <input name="pg_qa[7][question]" value="行走（平地45m）" type="hidden" />
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">穿脫衣服：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">大便控制：
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">小便控制：
                        <input name="pg_qa[10][question]" value="大便控制" type="hidden" />
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <p>评分标准：最高分100分。≥60分：良，生活基本自理；41~59分：日常生活需要他人帮助；21~40分：日常生活明显依赖他人；≤20分：日常生活完全依赖他人。
                        </p>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-md-1 control-label" style="padding-right: 10px">评估结论 ：</label>
                        <div class="col-md-11">
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-1 control-label" style="padding-right: 5px">不自理原因 ：</label>
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-1 control-label" style="padding-right: 0px;padding-left: 6px;">肢体残疾部位 ：</label>
