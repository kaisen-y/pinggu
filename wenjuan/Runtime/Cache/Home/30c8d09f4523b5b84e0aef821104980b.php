            ...
            <input type="hidden" name="goto" value="/questionnaire/qita/care_id/<?php echo ($care_id); ?>/oname/kfxqpg" />
                <fieldset class="row">
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-12 control-label">对客观事物的主观态度体验是否与实际相符，能否被常人理解。
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-12 control-label">动作行为表现有否异常。
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class="col-md-12 control-label">在交流中能否互相理解。
                    ...
                    <div class="form-group col-md-12">
                        <p>评分标准：0 - 1分情绪行为正常&nbsp;&nbsp;2 - 5分情绪行为轻度异常&nbsp;&nbsp; 6 - 14分情绪行为中度异常&nbsp;&nbsp;15分或以上情绪行为重度异常
                        </p>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="col-md-1 control-label" style="padding-right: 5px">情绪 ：</label>
                        <div class="col-md-11">
                        ...
                        <label class="col-md-1 control-label" style="padding-right: 5px">行为 ：</label>
                        <div class="col-md-11">
                            <label class="checkbox-inline">
                        ...
                        <label class="col-md-1 control-label" style="padding-right: 5px">沟通能力 ：</label>
                        <div class="col-md-11">
                            <label class="checkbox-inline">
                ...
                <h3>肢体康复评估</h3>
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">坐位平衡：<br>
                            被测者取端坐位。双足接地。双手置于腿上。腰背自然伸直，双眼平视前方。 </label>
                        <div class="radio">
                            <label>
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">立位平衡：<br>
                            被测者取直立位。双足与肩同宽。双手自然下垂。腰背自然伸直，双眼平视前方。 </label>
                        <div class="radio">
                            <label>
                    ...
                    <div class="form-group col-md-12">
                        <label class="col-md-12 control-label">Holden步行能力评定：</label>
                            <div class="radio">
                                <label>
                        ...
                        <div class=".">
                            <h3>视觉能力评估</h3>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <label class="col-md-12 control-label" style="margin-bottom:10px; ">有否视力障碍，能否安全照顾自己；</label>
                                    <div class="radio">
                                        <label>
