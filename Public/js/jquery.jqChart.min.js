...
//			c.push(a)
	...
	B.prototype._getStripes = function(b) {
		...
		a.each(d, function() {
			...
			if (a.width)
				...
				j = b.actualInterval;
			for ( var h = a.lineWidth, o = h / 2, n = b._getIntervals(k, a,
	...
	s.prototype._createRenderShape = function(f, g, e) {
		...
		for ( var c = [], h = this.sharedAxis.actualMaximum, l = 2 * Math.PI
				/ h, f = this.cx, g = this.cy - e, d = 0; d < h; d++) {
